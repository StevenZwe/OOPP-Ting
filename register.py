...
class Base:
    def __init__(self,password,email,name,school,identity):
        self.__userid=''
...
class User(Base):
    def __init__(self,admin_no,password,email,name,school,identity,course_name,pem_class):
        super().__init__(password, email, name, school, identity)
...
class Admin(Base):
    def __init__(self,admin_no,password,email,name,school,identity):
        super().__init__(password,email,name,school,identity)
        self.__admin_no = admin_no
    def get_admin_no(self):
        return self.__admin_no
